...
\change
A function returning an implicitly movable entity may invoke
a constructor taking an rvalue reference to a type
...
\effect
Valid C++17 code may become ill-formed in this International Standard.
For example:
\begin{codeblock}
struct base {
    base();
