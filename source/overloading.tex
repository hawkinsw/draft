...
the guides of \tcode{A} are the set of function or function templates
formed as follows.
...
\item
  ...
  from \tcode{B<L>} according to the process in\iref{temp.deduct.type}
...
// The guides for \tcode{B} derived from the above \tcode{f1'} and \tcode{f2'} for \tcode{A} are
