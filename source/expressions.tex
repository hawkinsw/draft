...
\pnum
Simple assignments where the left operand is a \tcode{volatile}-qualified type
that is not of class type are deprecated\iref{depr.volatile.type}
unless they are either a discarded-value expression or
