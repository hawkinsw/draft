...
\item
  ...
  in the same manner as for \tcode{__LINE__} and \tcode{__FILE__}.
...
\tcode{file_name_} &
  A presumed name of the current source file\iref{cpp.predefined} as an NTBS.
  \\ \rowsep
\tcode{function_name_} &
  A name of the current function
  such as in \tcode{__func__}\iref{dcl.fct.def.general} if any,
  an empty string otherwise. \\
\end{libefftabvalue}

\item
  Otherwise, that is, when invoked in some other way, returns a
